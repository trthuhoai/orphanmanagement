        ...
        return (
            <div className="container">
                ...
                <Navbar style={{ position: "fixed" }} bg="light" expand="lg">
                    ...
                    <Container
                        style={{ marginright: "0cm", marginLeft: "17cm" }}
                    >
                ...
                >
                    ...
                    <p className="p-info">
                        ...
                        - Các phòng:
                        <p className="p-info">1. Phòng Tổ chức Hành chính.</p>
                        <p className="p-info">2. Phòng Tư vấn và Trợ giúp.</p>
                        <p className="p-info">
                            3. Phòng Tiếp nhận, quản lý và chăm sóc đối tượng.
                        </p>
                        <p className="p-info">4. Phòng Y tế nuôi dưỡng.</p>
                        <p className="p-info">
